...
/**
 * REST controller for managing {@link ar.edu.um.fincasapp.fincasms.domain.Finca}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FincaResource {
    ...
    public ResponseEntity<Finca> updateFinca(@Valid @RequestBody Finca finca) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, finca.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<Finca>> getAllFincas(Pageable pageable) {
        ...
        Page<Finca> page = fincaRepository.findAll(pageable);
